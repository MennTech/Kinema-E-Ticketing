            ...
            <form action="">
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="namaMakananInput" placeholder="{{ $_GET['nama'] }}">
                    </div>
                    <div class="col-3">
                        <label for="stockInput" class="form-label">Stock Makanan</label>
                        <input type="number" class="form-control" id="stockInput" placeholder="{{ $_GET['stock'] }}">
                    </div>
                    <div class="col-3">
                        <label for="hargaInput" class="form-label">Harga Makanan</label>
                        <input type="number" class="form-control" id="hargaInput" placeholder="{{ $_GET['harga'] }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-12">
                        <label for="gambarMakananInput" class="form-label">Gambar Makanan</label>
                        <input type="file" class="form-control" id="gambarMakananInput" accept=".jpg, .jpeg"placeholder="{{ $_GET['gambar'] }}">
                    </div>
                </div>
