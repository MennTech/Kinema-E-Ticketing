...
<body id="body-pd">    
    ...
    <div class="l-navbar" id="nav-bar">
      <nav class="nav">
          <div> 
            <a href="/Admin" class="nav_logo"> <img src="img/favicon.png" alt="" class="nav_logo-icon">
              <span class="nav_logo-name">Kinema</span> 
            </a>
            <div class="nav_list">
                <a href="/Admin" class="nav_link"><img src="img/{{ $foto_profile }}" alt="" class="rounded-circle" id="profile"><span class="nav_name">{{ $name }}</span> </a>
                <a href="/Admin" class="nav_link {{ ($title === 'dashboard') ? 'active' : '' }}"><i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> 
