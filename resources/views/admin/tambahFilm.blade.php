                ...
                <form action="">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="sutradaraInput">
                        </div>
                        <div class="col-6">
                            <label for="actorInput" class="form-label">Actor Film</label>
                            <input type="text" class="form-control" id="actoriInput">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            <label for="sinopsisInput" class="form-label">Sinopsis Film</label>
                            <textarea class="form-control" id="sinopsisInput" rows="4"></textarea>
                        </div>
                    </div>
